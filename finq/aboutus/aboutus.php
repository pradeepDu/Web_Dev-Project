...
<div class="container">
        ...
        <div class="profiles">
            <div class="profile">
                <img src="../assets/sujal.jpg" class="profileimg">
                <h3 class="username">Sujal</h3>
                <p>Sujal Ambatkar</p>
            </div>
            <div class="profile">
                <img src="../assets/rucha.jpg" class="profileimg">
                <h3 class="username">Rucha</h3>
                <p>Rucha Gavade</p>
            </div>
            <div class="profile">
                <img src="../assets/pradeep.jpg" class="profileimg">
                <h3 class="username">Pradeep</h3>
                <p>H. Pradeep</p>
            </div>
            <div class="profile">
                <img src="../assets/atharva.jpg" class="profileimg">
